    ...
    >
      ...
      >
        <div className="flex w-full items-center justify-between">
          <Link to="/">
            ...
            >
              <Gift className="h-8 w-8" style={{ color: 'oklch(var(--primary))' }} />
              <span style={{ color: 'oklch(var(--foreground))' }} className="text-lg font-bold tracking-wider">Secret Santa</span>
            </motion.div>
          </Link>
      ...
      >
        <Link to="/">
          ...
          >
            <Gift className="h-8 w-8" style={{ color: 'oklch(var(--primary))' }} />
            <span style={{ color: 'oklch(var(--foreground))' }} className="text-lg font-extrabold tracking-wider">Secret Santa</span>
          </motion.div>
        </Link>
